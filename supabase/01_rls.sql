...
-- 3. LIMPEZA E CRIAÇÃO DE POLÍTICAS (USANDO BLOCO SEGURO)
DO $$ 
BEGIN
    -- PROFILES
    ...
    -- TAREFAS (CRÍTICO PARA O BOTÃO PULAR)
    ...
    -- Esta política permite que você atualize apenas as tarefas que estão atribuídas a você
